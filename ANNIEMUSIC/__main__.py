...
async def init():
    ...
    LOGGER("ANNIEMUSIC").info(
        "\x52\x69\x73\x68\x75\x20\x4d\x75\x73\x69\x63\x20\x62\x6f\x74\x20\x53\x74\x61\x72\x74\x65\x64\x20\x53\x75\x63\x63\x65\x73\x73\x66\x75\x6c\x6c\x79\x2e\x2e\x2e\xf0\x9f\x8f\xa9"
    )
    await idle()
    await app.stop()
    await userbot.stop()
